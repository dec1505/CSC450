...
def main():
    ...
    print(a.create_palette(user_image, palette_num))
...
#         r, g, b = xmeans[i], ymeans[i], zmeans[i]
...
#         xmeans, ymeans, zmeans, change = refinemean(
#             palette_num, catlist, xlist, ylist, zlist, xmeans, ymeans, zmeans
#         )
#
